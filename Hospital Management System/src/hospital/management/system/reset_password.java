...
public class reset_password extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "RESET PASSWORD", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("sansserif", 1, 14))); // NOI18N
        ...
        reset.setIcon(new javax.swing.ImageIcon(getClass().getResource("/hospital/management/system/reset1.png"))); // NOI18N
        ...
        if (pass1.getText().equals(pass2.getText())) {
            try {
                ...
                String password = "admin1";
                 ...
                 String query = "UPDATE REGISTERED SET PASSWORD = '"+pass1.getText().hashCode()+"' WHERE USERNAME = '"+user+"' AND ID = '"+id+"' ";
                 stat.execute(query);
    ...
    public static void reset(String n1, String n2) {
